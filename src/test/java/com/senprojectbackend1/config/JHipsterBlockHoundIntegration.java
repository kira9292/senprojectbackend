...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("com.senprojectbackend1.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("com.senprojectbackend1.security.DomainUserDetailsService", "createSpringSecurityUser");
